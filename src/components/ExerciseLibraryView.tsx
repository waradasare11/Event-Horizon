...
export const ExerciseLibraryView: React.FC<ExerciseLibraryViewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      {/* Cosmic Hero Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0B0F1E] via-[#10172A] to-[#1E1B4B] border border-cyan-500/30 p-6 sm:p-8 text-white shadow-2xl shadow-cyan-950/40">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/15 border border-cyan-400/40 text-cyan-300 text-xs font-bold tracking-wider uppercase">
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight font-['Space_Grotesk',sans-serif]">
              Evidence-Based <span className="bg-gradient-to-r from-cyan-300 via-indigo-200 to-purple-400 bg-clip-text text-transparent">Exercise Library</span>
            </h1>
          ...
          <div className="grid grid-cols-3 gap-3 shrink-0">
            <div className="p-3.5 rounded-2xl bg-[#0F1528]/80 border border-slate-700/60 text-center">
              <div className="text-xl sm:text-2xl font-black text-cyan-300 font-['Space_Grotesk',sans-serif]">
                {RAW_EXERCISE_REGISTRY.length}
              </div>
              <div className="text-[11px] text-slate-400 font-medium mt-0.5">Exercises</div>
            </div>
            <div className="p-3.5 rounded-2xl bg-[#0F1528]/80 border border-slate-700/60 text-center">
              <div className="text-xl sm:text-2xl font-black text-purple-400 font-['Space_Grotesk',sans-serif]">
                {favoriteIds.length}
              </div>
              <div className="text-[11px] text-slate-400 font-medium mt-0.5">Favorited</div>
            </div>
            <div className="p-3.5 rounded-2xl bg-[#0F1528]/80 border border-slate-700/60 text-center">
              <div className="text-xl sm:text-2xl font-black text-emerald-400 font-['Space_Grotesk',sans-serif]">
                4
              </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#080B14] text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-cyan-500"
            />
            {searchQuery && (
              <button
                type="button"
          ...
          filteredExercises.map((exercise) => {
            ...
            return (
              <div
                ...
                className="group relative flex flex-col justify-between p-5 rounded-2xl bg-white dark:bg-[#0E1424] border border-slate-200 dark:border-slate-800 hover:border-cyan-500/50 hover:shadow-xl hover:shadow-cyan-950/20 transition-all cursor-pointer"
              >
                <div>
                  {/* Top Bar: Category, Tier & Favorite Button */}
                  <div className="flex items-center justify-between gap-2 mb-2.5">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <span className="text-[10px] font-extrabold uppercase tracking-wider px-2 py-0.5 rounded-md bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border border-cyan-500/20">
                        {exercise.category}
                      </span>
                  ...
                  <h3 className="font-bold text-base text-slate-900 dark:text-white group-hover:text-cyan-400 transition-colors line-clamp-1 font-['Space_Grotesk',sans-serif]">
                    {exercise.formalName}
                  </h3>
                  ...
                  {rec.lastPerformed ? (
                    <div className="mt-2.5 flex items-center justify-between gap-1 text-[11px] font-bold text-emerald-700 dark:text-emerald-300 bg-emerald-500/10 px-2.5 py-1 rounded-lg border border-emerald-500/25">
                      ...
                      <span className="shrink-0 text-[10px] text-emerald-600 dark:text-emerald-400 font-extrabold bg-emerald-500/20 px-1.5 py-0.5 rounded">
                  ...
                  <div className="mt-2 flex items-center justify-between gap-1.5 p-2 rounded-xl bg-cyan-500/10 dark:bg-cyan-950/30 border border-cyan-500/20 text-[11px]">
                    <div className="flex items-center gap-1.5 text-cyan-700 dark:text-cyan-300 font-bold truncate">
                      <TrendingUp className="w-3.5 h-3.5 text-cyan-500 shrink-0" />
                      <span className="truncate">{rec.progressionNote}</span>
                    </div>
                    <span className="shrink-0 font-black text-cyan-700 dark:text-cyan-300 bg-cyan-500/20 px-1.5 py-0.5 rounded text-[10px]">
                ...
                <div className="pt-3.5 mt-3.5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-2">
                  <span className="text-[11px] text-cyan-600 dark:text-cyan-400 font-semibold group-hover:underline flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 rounded-lg bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-700 dark:text-cyan-300 border border-cyan-400/30 text-[11px] font-bold transition-all flex items-center gap-1 cursor-pointer"
      ...
      {selectedExercise && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in">
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl bg-white dark:bg-[#0E1424] border border-slate-200 dark:border-cyan-500/40 shadow-2xl p-6 sm:p-8 text-slate-900 dark:text-white space-y-6">
            {/* Modal Header */}
            <div className="flex items-start justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-xs font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full bg-cyan-500/15 text-cyan-600 dark:text-cyan-300 border border-cyan-500/30">
                    {selectedExercise.category}
                  </span>
                  <span className="text-xs font-bold px-2.5 py-0.5 rounded-full bg-purple-500/15 text-purple-600 dark:text-purple-300 border border-purple-500/30">
            ...
            {selectedExercise.executionKeypoint && (
              <div className="p-4 rounded-2xl bg-cyan-500/10 dark:bg-cyan-950/30 border border-cyan-500/30 space-y-1">
                ...
                <p className="text-xs sm:text-sm text-slate-700 dark:text-cyan-100 leading-relaxed">
                  {selectedExercise.executionKeypoint}
                </p>
              </div>
            )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {selectedExercise.coachingChannels.map((guide) => (
                  <a
                    ...
                    className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-[#080B14] border border-slate-200 dark:border-slate-800 hover:border-cyan-500/50 hover:bg-slate-100 dark:hover:bg-[#131B32] transition-all group"
                  >
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="text-xs font-bold text-slate-900 dark:text-white truncate group-hover:text-cyan-400">
                          {guide.channelName}
                        </div>
            ...
            <div className="flex items-center justify-between gap-3 pt-4 border-t border-slate-200 dark:border-slate-800">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-indigo-600 text-white text-xs sm:text-sm font-bold shadow-lg shadow-cyan-500/25 hover:opacity-90 transition-all flex items-center gap-2 cursor-pointer"
              >
      ...
      {quickLogExercise && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in">
          <div className="relative w-full max-w-md rounded-3xl bg-white dark:bg-[#0E1424] border border-cyan-500/40 shadow-2xl p-6 text-slate-900 dark:text-white space-y-5">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-[11px] font-bold text-cyan-400 uppercase tracking-wider">Quick Workout Logging</div>
            ...
            {quickLogSuccess ? (
              <div className="py-8 text-center space-y-2">
                ...
                <div className="text-base font-bold text-emerald-400">Sets Successfully Logged!</div>
              ...
              <>
                ...
                {activeProgression && (
                  <div className="p-3.5 rounded-2xl bg-cyan-500/10 border border-cyan-500/30 space-y-1.5">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] font-extrabold uppercase tracking-wider text-cyan-500 dark:text-cyan-400 flex items-center gap-1.5">
                        <Sparkles className="w-3.5 h-3.5 text-cyan-400" />
                      ...
                      <button
                        ...
                        className="text-[10px] text-cyan-500 dark:text-cyan-300 font-bold hover:underline flex items-center gap-1"
                      >
                        <RotateCcw className="w-3 h-3" />
                        <span>Reset to Target</span>
                      </button>
                    </div>
                    <p className="text-xs font-semibold text-slate-800 dark:text-cyan-100">
                      {activeProgression.progressionNote}
                    </p>
                    {activeProgression.lastPerformed ? (
                      <div className="text-[11px] text-slate-600 dark:text-slate-300 pt-1 border-t border-cyan-500/20 flex items-center justify-between">
                      ...
                      <div className="text-[11px] text-slate-500 dark:text-slate-400 pt-1 border-t border-cyan-500/20">
                ...
                <div className="p-3 rounded-xl bg-slate-100 dark:bg-[#080B14] text-xs text-slate-500 dark:text-slate-400 flex items-center justify-between">
                  ...
                  <span className="font-bold text-cyan-400">{(logSetsCount * logReps * logWeight).toLocaleString()} kg</span>
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-indigo-600 text-white text-xs font-bold shadow-md shadow-cyan-500/25 cursor-pointer hover:opacity-90 transition-opacity"
                  >
                    Confirm & Log
                  </button>
                </div>
