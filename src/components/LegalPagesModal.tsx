        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          ...
          {activeTab === 'privacy' && (
            <div className="space-y-5 animate-in fade-in duration-150">
              <div className="p-4 rounded-xl bg-teal-500/10 border border-teal-500/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                <section className="space-y-2">
                  ...
                  <p>
                    This application (<strong>AROH</strong>) is developed, operated, and maintained by <strong>Warad Asare</strong> (individual developer and sole proprietor trading as AROH AI Technologies), located in <strong>Pune, Maharashtra, India</strong>. Contact Email: <a href="mailto:waradasare11@gmail.com" className="text-teal-600 dark:text-teal-400 font-semibold underline">waradasare11@gmail.com</a>.
                  </p>
                </section>
                ...
                <section className="space-y-2">
                  ...
                  <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-900 dark:text-emerald-300 font-semibold">
                ...
                <div className="space-y-4 text-xs sm:text-sm">
                  ...
                  <div className="p-4 rounded-xl border border-red-500/30 bg-red-500/5 space-y-3">
                    ...
                    <input
                      ...
                      className="w-full text-sm p-3 rounded-xl border border-red-300 dark:border-red-900/60 bg-white dark:bg-[#111312] text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-red-500 font-mono"
                    />
