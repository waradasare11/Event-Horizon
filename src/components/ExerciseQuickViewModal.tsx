        ...
        <div className="p-5 border-b border-[#E5E7EB] dark:border-[#2A2416] bg-[#FAFAF8] dark:bg-[#1B1E1D] flex items-start justify-between gap-3 shrink-0">
          <div>
            <div className="flex flex-wrap items-center gap-2 mb-1.5">
              ...
              {/* Category */}
              <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-[#3B82F6]/10 text-[#3B82F6] dark:text-[#60A5FA]">
                {hindiCategory}
              </span>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="px-2 py-0.5 rounded-md bg-[#3B82F6]/10 dark:bg-[#3B82F6]/20 text-[#3B82F6] dark:text-[#60A5FA] font-bold text-xs">
            ...
            >
              {isCopied ? (
                <>
                  ...
                  <span className="text-[#1D4ED8] dark:text-[#60A5FA] font-bold">Copied!</span>
                </>
              ) : (
                <>
        ...
        <div className="p-5 overflow-y-auto space-y-4 text-xs">
          ...
          <div className="rounded-2xl overflow-hidden border border-[#E5E7EB] dark:border-[#2A2416] bg-[#FAFAF8] dark:bg-[#111111] shadow-xs">
            ...
            <div className="flex items-center justify-between p-2 border-b border-[#E5E7EB] dark:border-[#262A28] bg-gray-50 dark:bg-[#181B1A] gap-2 flex-wrap">
              ...
              <span className="text-[11px] font-semibold text-[#3B82F6] dark:text-[#60A5FA] flex items-center gap-1">
            ...
            {visualMode === 'biomechanics' || imageError ? (
              ...
              <div className="h-52 sm:h-64 w-full overflow-hidden relative bg-black">
                ...
                <div className="absolute top-3 left-3 right-3 flex items-center justify-between gap-2">
                  ...
                  <span className="px-2.5 py-1 rounded-lg bg-[#3B82F6]/90 backdrop-blur-md text-white text-[11px] font-bold border border-white/20">
            ...
            <div className="p-3 bg-gray-50 dark:bg-[#181B1A] border-t border-[#E5E7EB] dark:border-[#262A28] grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px]">
              <div className="flex items-start gap-1.5">
                <span className="font-bold text-[#3B82F6] dark:text-[#60A5FA] shrink-0">Phase Guide:</span>
          ...
          <div className="p-3.5 rounded-xl bg-[#3B82F6]/10 border border-[#3B82F6]/20 text-[#1A1D1B] dark:text-[#E8ECE9]">
            <div className="flex items-center justify-between gap-2 mb-2 flex-wrap">
              <div className="flex items-center gap-1.5 font-bold text-[#3B82F6] dark:text-[#60A5FA] text-xs">
              ...
              <button
                ...
                className="px-3 py-1 rounded-lg bg-[#3B82F6] hover:bg-[#1D4ED8] text-white font-bold text-[11px] flex items-center gap-1.5 transition-colors cursor-pointer disabled:opacity-50"
              >
            ...
            {groundingData ? (
              <div className="space-y-2 mt-2 pt-2 border-t border-[#3B82F6]/20">
                ...
                {groundingData.webSources && groundingData.webSources.length > 0 && (
                  <div className="pt-2">
                    <span className="font-bold text-[10px] text-[#3B82F6] dark:text-[#60A5FA] block mb-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {groundingData.webSources.map((src, sIdx) => (
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-[10px] text-[#3B82F6] dark:text-[#60A5FA] hover:underline font-medium bg-[#3B82F6]/10 px-2 py-0.5 rounded-md"
                        >
                          <span>{src.title}</span>
          ...
          <div className="space-y-3 p-4 rounded-xl bg-white dark:bg-[#1C1F1E] border border-[#E5E7EB] dark:border-[#282C2A] shadow-2xs">
            <div className="flex items-center justify-between border-b border-[#E5E7EB] dark:border-[#282C2A] pb-2">
              <div className="flex items-center gap-2">
                <CheckSquare className="w-4 h-4 text-[#3B82F6] dark:text-[#60A5FA]" />
            ...
            <div className="space-y-2">
              {guide.setup.map((s, idx) => (
                <div 
                  ...
                  className={`flex items-start gap-2.5 p-2 rounded-lg transition-all cursor-pointer select-none border ${
                    checkedFormItems[idx]
                      ? 'bg-[#3B82F6]/10 border-[#3B82F6]/30 text-[#8E701C] dark:text-[#60A5FA]'
                ...
                >
                  <button className="mt-0.5 shrink-0 text-[#3B82F6] dark:text-[#60A5FA]">
                    {checkedFormItems[idx] ? (
          ...
          <div className="space-y-3.5 p-4 rounded-xl bg-white dark:bg-[#1C1F1E] border border-[#E5E7EB] dark:border-[#282C2A] shadow-2xs">
            <div className="flex items-center gap-2 border-b border-[#E5E7EB] dark:border-[#282C2A] pb-2">
              <BookOpen className="w-4 h-4 text-[#3B82F6] dark:text-[#60A5FA]" />
              <h3 className="font-bold text-sm text-[#1A1D1B] dark:text-[#E8ECE9]">
            ...
            {/* Overview */}
            <div>
              <span className="font-bold text-[#3B82F6] dark:text-[#60A5FA] block mb-1">
            ...
            {/* 2. Breathing & Tempo */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 p-3 rounded-xl bg-[#3B82F6]/5 dark:bg-[#2A2416]/20 border border-[#3B82F6]/20">
              <div>
                <span className="font-bold text-[11px] text-[#3B82F6] dark:text-[#60A5FA] block mb-0.5">
          ...
          {exercise.injuryAlternative && (
            <div className="p-3 rounded-xl bg-[#3B82F6]/10 border border-[#3B82F6]/20 text-xs">
              <span className="font-bold text-[#8E701C] dark:text-[#60A5FA] block mb-0.5">
