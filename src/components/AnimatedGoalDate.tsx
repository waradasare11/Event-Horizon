  ...
  return (
    <div className={`space-y-3 ${className}`}>
      <div className="flex items-center gap-2">
        ...
        {isDone && (
          <span className="inline-flex items-center gap-1 text-[11px] font-bold text-[#38BDF8] animate-in fade-in">
      ...
      <div className="flex flex-wrap items-center gap-3 pt-1 text-xs sm:text-sm text-[#F8FAFC]/90">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-white/10 backdrop-blur-xs border border-white/15">
          ...
          <span className="text-[#38BDF8]">({displayedDays} Days from Today)</span>
        </div>

        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-white/10 backdrop-blur-xs border border-white/15 text-[11px] text-[#38BDF8]">
