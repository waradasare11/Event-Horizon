      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-white dark:bg-[#161817] p-5 rounded-3xl border border-[#E5E7EB] dark:border-[#242826] shadow-xs space-y-4">
            <div className="relative aspect-4/3 w-full bg-[#1A1D1B] rounded-2xl overflow-hidden border border-[#E5E7EB] dark:border-[#242826] flex items-center justify-center">
              {isMatching ? (
                <div className="flex flex-col items-center justify-center p-6 text-center space-y-3">
                  <RefreshCw className="w-10 h-10 text-[#0F6E5F] animate-spin" />
                ...
                <div className="text-center p-6 space-y-2">
                  <ChefHat className="w-12 h-12 text-[#0F6E5F] mx-auto opacity-60" />
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-[#FAFAF8] dark:bg-[#1F2421] border border-[#E5E7EB] dark:border-[#242826] rounded-xl text-xs font-medium text-[#1F2421] dark:text-[#F5F5F0] focus:ring-2 focus:ring-[#0F6E5F] outline-hidden"
              />
            </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                disabled={isMatching}
                className="flex-1 px-4 py-3 bg-[#0F6E5F] hover:bg-[#0D5A4E] text-white font-bold text-xs sm:text-sm rounded-2xl shadow-xs transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
            ...
            <div className="pt-2 border-t border-[#F0F0EC] dark:border-[#242826]">
              ...
              <div className="grid grid-cols-2 gap-2">
                {SAMPLE_MATCH_ITEMS.map((sample) => (
                  <button
                    ...
                    disabled={isMatching}
                    className="p-2.5 bg-[#FAFAF8] dark:bg-[#1A1D1C] hover:bg-emerald-50 dark:hover:bg-[#0F6E5F]/20 border border-[#E5E7EB] dark:border-[#242826] rounded-xl text-left transition-all cursor-pointer disabled:opacity-50"
                  >
                    <div className="font-bold text-[11px] text-[#1F2421] dark:text-[#F5F5F0] truncate">
                      {sample.title}
                    </div>
                    <div className="text-[10px] text-[#0F6E5F] dark:text-emerald-400 mt-0.5">
                      {sample.region}
                    </div>
                  </button>
                ))}
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          {matchResult ? (
            <div className="bg-white dark:bg-[#161817] p-6 rounded-3xl border border-[#E5E7EB] dark:border-[#242826] shadow-xs space-y-5">
              {/* Header Title & Match Score */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#F0F0EC] dark:border-[#242826] pb-4">
                <div>
                  <div className="flex items-center gap-2">
                    <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-[#0F6E5F]/10 text-[#0F6E5F] dark:text-emerald-400 uppercase tracking-wider">
                      {matchResult.regionalOrigin}
                    </span>
                    <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 flex items-center gap-1">
                ...
                <button
                  ...
                  className="px-4 py-2.5 bg-[#0F6E5F] hover:bg-[#0D5A4E] text-white font-bold text-xs rounded-xl shadow-xs transition-all flex items-center justify-center gap-1.5 cursor-pointer shrink-0"
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div className="p-3 bg-emerald-50/50 dark:bg-emerald-950/20 rounded-2xl border border-emerald-100 dark:border-emerald-900/40 text-center">
                  <div className="text-xs font-bold text-[#0F6E5F] dark:text-[#1D9E75]">Protein</div>
              ...
              <div className="p-4 bg-[#FAFAF8] dark:bg-[#1A1D1C] rounded-2xl border border-[#E5E7EB] dark:border-[#242826] space-y-2">
                <div className="text-xs font-bold text-[#1F2421] dark:text-[#F5F5F0] flex items-center gap-1.5">
                  <BookOpen className="w-3.5 h-3.5 text-[#0F6E5F]" />
                ...
                <div className="text-[11px] font-semibold text-[#0F6E5F] dark:text-emerald-400">
              ...
              <div className="space-y-2">
                <div className="text-xs font-bold text-[#1F2421] dark:text-[#F5F5F0] flex items-center justify-between">
                  <span className="flex items-center gap-1.5">
                    <Scale className="w-3.5 h-3.5 text-[#0F6E5F]" />
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                  {matchResult.deconstructedIngredients.map((ing, i) => (
                    <div
                      key={i}
                      className="p-2.5 bg-[#FAFAF8] dark:bg-[#1A1D1C] rounded-xl border border-[#E5E7EB] dark:border-[#242826] flex items-center justify-between text-xs"
                    >
                      <div>
                        ...
                        <div className="text-[10px] text-[#0F6E5F] dark:text-emerald-400">
                          {ing.source}
                        </div>
                      </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="p-3.5 bg-emerald-50/50 dark:bg-emerald-950/20 rounded-2xl border border-emerald-100 dark:border-emerald-900/40 space-y-1">
                  <div className="text-xs font-bold text-emerald-800 dark:text-emerald-300 flex items-center gap-1.5">
                    <Flame className="w-3.5 h-3.5 text-[#0F6E5F]" />
              ...
              <div className="pt-3 border-t border-[#F0F0EC] dark:border-[#242826] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    {matchResult.matchedWebSources.slice(0, 2).map((src, idx) => (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1 text-[10px] text-[#0F6E5F] dark:text-emerald-400 hover:underline bg-[#FAFAF8] dark:bg-[#1A1D1C] px-2 py-0.5 rounded-md border border-[#E5E7EB] dark:border-[#242826]"
                      >
            ...
            <div className="p-12 bg-white dark:bg-[#161817] rounded-3xl border border-[#E5E7EB] dark:border-[#242826] shadow-xs text-center space-y-3">
              <Search className="w-12 h-12 text-[#0F6E5F] mx-auto opacity-40" />
