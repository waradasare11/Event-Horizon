...
export const CloudSyncWidget: React.FC<CloudSyncWidgetProps> = ({
  ...
  return (
    <div
      ...
      className="mt-4 pt-4 border-t border-[#E5E7EB] dark:border-[#1E293B] flex flex-col md:flex-row md:items-center justify-between gap-3.5 text-left"
    >
      {/* Left: Google Workspace Services Indicators */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-xl bg-[#00D4FF]/10 dark:bg-[#00D4FF]/20 text-[#0369A1] dark:text-[#38BDF8] flex items-center justify-center shrink-0">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#00D4FF]/10 text-[#0369A1] dark:text-[#38BDF8] border border-[#00D4FF]/20">
                <span className="w-1.5 h-1.5 rounded-full bg-[#00D4FF] animate-pulse" />
                <span>Connected</span>
              </span>
            </div>
            <p className="text-[11px] text-[#6B7280] dark:text-[#9EA8A2] flex items-center gap-1.5 mt-0.5">
              <FolderSync className="w-3 h-3 text-[#00D4FF] dark:text-[#38BDF8]" />
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-[#FAFAF8] dark:bg-[#1E2220] border border-[#E5E7EB] dark:border-[#1E293B] text-[10px] font-semibold text-[#1A1D1B] dark:text-[#E8ECE9]">
            <HardDrive className="w-3 h-3 text-[#00D4FF] dark:text-[#38BDF8]" />
          ...
          <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-[#FAFAF8] dark:bg-[#1E2220] border border-[#E5E7EB] dark:border-[#1E293B] text-[10px] font-semibold text-[#1A1D1B] dark:text-[#E8ECE9]">
            <CheckSquare className="w-3 h-3 text-[#00D4FF]" />
            <span>Tasks</span>
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 self-start md:self-center shrink-0">
        <button
          ...
          className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 text-xs font-bold rounded-xl bg-[#00D4FF] hover:bg-[#0369A1] text-white shadow-xs transition-all active:scale-95 cursor-pointer disabled:opacity-50 min-h-[38px]"
      ...
      {(backupMessage || errorMessage) && (
        <div className="w-full mt-2">
          {backupMessage && (
            <div className="p-2.5 rounded-xl bg-[#00D4FF]/10 border border-[#00D4FF]/20 text-[#075985] dark:text-[#38BDF8] text-xs flex items-center gap-2">
