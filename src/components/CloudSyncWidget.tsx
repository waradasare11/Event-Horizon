...
export const CloudSyncWidget: React.FC<CloudSyncWidgetProps> = ({
  ...
  return (
    <div
      ...
      className="mt-4 pt-4 border-t border-[#E5E7EB] dark:border-[#242826] flex flex-col md:flex-row md:items-center justify-between gap-3.5 text-left"
    >
      {/* Left: Google Workspace Services Indicators */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-xl bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 flex items-center justify-center shrink-0">
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-[#FAFAF8] dark:bg-[#1E2220] border border-[#E5E7EB] dark:border-[#2A2E2C] text-[10px] font-semibold text-[#1A1D1B] dark:text-[#E8ECE9]">
            <HardDrive className="w-3 h-3 text-[#0F6E5F] dark:text-[#2DD4BF]" />
