  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300 text-left">
      ...
      <div className="bg-white dark:bg-[#111111] p-6 sm:p-8 rounded-2xl border border-[#E5E7EB] dark:border-[#2A2416] shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-6 transition-colors">
        ...
        {/* View Switcher Chips */}
        <div className="flex flex-wrap items-center gap-2 bg-[#FAFAF8] dark:bg-[#1E201F] p-1.5 rounded-xl border border-[#E5E7EB] dark:border-[#2A2416] shrink-0">
          <button
      ...
      {plannerSubView === 'daily_blueprint' && (
        <div className="bg-white dark:bg-[#111111] p-6 sm:p-8 rounded-2xl border border-[#E5E7EB] dark:border-[#2A2416] shadow-xs space-y-6 transition-colors">
              ...
              {aiMealPlan.meals.map((meal, idx) => (
                ...
                >
                  <div>
                    ...
                    {/* Ingredients List */}
                    <div className="mt-3 pt-3 border-t border-[#E5E7EB] dark:border-[#2A2416]">
                  ...
                  <div className="mt-4 pt-3 border-t border-[#E5E7EB] dark:border-[#2A2416] space-y-2">
                    ...
                    <button
                      ...
                      className="w-full py-1.5 px-3 rounded-lg border border-[#E5E7EB] dark:border-[#2A2416] bg-white dark:bg-[#1E201F] hover:bg-[#FAFAF8] dark:hover:bg-[#282C2A] text-xs font-semibold text-[#1A1D1B] dark:text-[#E8ECE9] flex items-center justify-center gap-1.5 transition-all shadow-2xs cursor-pointer disabled:opacity-50"
                    >
                      {swappingMealIdx === idx ? (
                        <>
          ...
          <div className="p-4 rounded-xl bg-[#FAFAF8] dark:bg-[#111111] border border-[#E5E7EB] dark:border-[#2A2416] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2">
