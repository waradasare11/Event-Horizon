...
export function BiomechanicsFormAnalyzer({
  ...
  return (
    <div className="space-y-8">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-[#00D4FF]/10 via-[#00D4FF]/5 to-transparent border border-[#00D4FF]/20 rounded-2xl p-6 sm:p-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#00D4FF]/10 text-[#00D4FF] dark:text-[#38BDF8] text-xs font-semibold uppercase tracking-wider">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#00D4FF] hover:bg-[#0C584C] text-white text-sm font-semibold shadow-sm transition-all hover:scale-[1.02] cursor-pointer shrink-0"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          {/* Exercise Selector */}
          <div className="bg-white dark:bg-[#0E1424] border border-[#E5E7EB] dark:border-[#1E293B] rounded-2xl p-5 space-y-4 shadow-xs">
                ...
                return (
                  <button
                    ...
                    className={`text-left p-3 rounded-xl border text-xs font-medium transition-all cursor-pointer flex items-center gap-2.5 ${
                      isSelected
                        ? 'border-[#00D4FF] bg-[#00D4FF]/10 text-[#00D4FF] dark:text-[#38BDF8] font-semibold ring-1 ring-[#00D4FF]'
                        : 'border-[#E5E7EB] dark:border-[#1E293B] text-[#374151] dark:text-[#D1D5DB] hover:bg-gray-50 dark:hover:bg-[#1F2220]'
                    }`}
                  >
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-xs px-3 py-2 rounded-lg border border-[#E5E7EB] dark:border-[#1E293B] bg-transparent text-[#1A1D1B] dark:text-[#E8ECE9] focus:outline-none focus:ring-1 focus:ring-[#00D4FF]"
              />
            </div>
          </div>

          {/* Media Player / Frame Inspection Container */}
          <div className="bg-white dark:bg-[#0E1424] border border-[#E5E7EB] dark:border-[#1E293B] rounded-2xl overflow-hidden shadow-xs">
            <div className="p-3 border-b border-[#E5E7EB] dark:border-[#1E293B] flex items-center justify-between bg-gray-50/50 dark:bg-[#191B1A]">
              <div className="flex items-center gap-2 text-xs font-medium text-[#374151] dark:text-[#D1D5DB]">
                <FileVideo className="w-4 h-4 text-[#00D4FF]" />
            ...
            <div className="p-4 space-y-3">
              <button
                ...
                className="w-full py-3 px-4 rounded-xl bg-[#00D4FF] hover:bg-[#0C584C] disabled:bg-gray-400 text-white font-semibold text-sm flex items-center justify-center gap-2 shadow-sm transition-all cursor-pointer"
              >
                {isAnalyzing ? (
                  <>
          ...
          {formAnalyses.length > 1 && (
            <div className="bg-white dark:bg-[#0E1424] border border-[#E5E7EB] dark:border-[#1E293B] rounded-2xl p-4 space-y-3">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-2.5 rounded-xl border text-xs flex items-center justify-between transition-colors cursor-pointer ${
                      currentAnalysis?.id === a.id
                        ? 'border-[#00D4FF] bg-[#00D4FF]/5 text-[#00D4FF] dark:text-[#38BDF8]'
                        : 'border-[#E5E7EB] dark:border-[#1E293B] hover:bg-gray-50 dark:hover:bg-[#1F2220] text-[#374151] dark:text-[#D1D5DB]'
                    }`}
                  >
                    <div>
        ...
        <div className="lg:col-span-7">
          {currentAnalysis ? (
            <div className="bg-white dark:bg-[#0E1424] border border-[#E5E7EB] dark:border-[#1E293B] rounded-2xl p-6 sm:p-8 space-y-6 shadow-xs">
              {/* Score Header */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#E5E7EB] dark:border-[#1E293B]">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    <div className="text-3xl font-extrabold text-[#00D4FF] dark:text-[#38BDF8]">
                  ...
                  <div className={`px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1.5 ${
                    currentAnalysis.injuryRiskRating === 'Low'
                      ? 'bg-[#0E1424] dark:bg-[#1E293B]/40 text-[#0369A1] dark:text-[#38BDF8] border border-[#1E293B] dark:border-[#1E293B]'
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 rounded-xl bg-gray-50 dark:bg-[#1F2220] border border-[#E5E7EB] dark:border-[#1E293B] text-xs leading-relaxed text-[#374151] dark:text-[#D1D5DB]">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {currentAnalysis.jointMechanics.map((jm, i) => (
                      <div
                        key={i}
                        className="p-3.5 rounded-xl border border-[#E5E7EB] dark:border-[#1E293B] bg-gray-50/50 dark:bg-[#1B1D1C] space-y-1.5 text-xs"
                      >
                        <div className="flex items-center justify-between">
                          <span className="font-bold text-[#1A1D1B] dark:text-[#E8ECE9]">{jm.joint}</span>
                          <span className={`px-2 py-0.5 rounded-md text-[10px] font-bold ${
                            jm.rating === 'Optimal'
                              ? 'bg-[#161F38] text-[#075985] dark:bg-[#1E293B] dark:text-[#38BDF8]'
                    ...
                    {currentAnalysis.mechanicalFaults.map((f, i) => (
                      ...
                      >
                        ...
                        <div className="text-[11px] text-[#525B56] dark:text-[#9EA8A2] pl-1">
                          <span className="font-semibold text-[#00D4FF] dark:text-[#38BDF8]">Fix: </span>
                          {f.correctionCue}
                        </div>
                      </div>
                    ))}
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {currentAnalysis.actionableCuesNextSet.map((cue, i) => (
                      <div
                        key={i}
                        className="p-3 rounded-xl bg-[#00D4FF]/5 dark:bg-[#00D4FF]/10 border border-[#00D4FF]/20 text-xs flex items-start gap-3"
                      >
                        <span className="w-5 h-5 rounded-full bg-[#00D4FF] text-white flex items-center justify-center text-[11px] font-bold shrink-0 mt-0.5">
                          {i + 1}
                        </span>
              ...
              {currentAnalysis.scientificTakeaway && (
                <div className="p-4 rounded-xl bg-gray-50 dark:bg-[#1F2220] border border-[#E5E7EB] dark:border-[#1E293B] text-xs text-[#525B56] dark:text-[#9EA8A2] flex items-start gap-3">
              ...
              <div className="pt-2 flex justify-end">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-amber-600 dark:text-cyan-400 hover:bg-amber-50 dark:hover:bg-amber-950/30 rounded-xl border border-amber-300 dark:border-amber-800/60 transition-colors cursor-pointer"
                >
            ...
            <div className="bg-white dark:bg-[#0E1424] border border-[#E5E7EB] dark:border-[#1E293B] rounded-2xl p-12 text-center space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-[#00D4FF]/10 text-[#00D4FF] flex items-center justify-center mx-auto">
