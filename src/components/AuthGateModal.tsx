...
export const AuthGateModal: React.FC<AuthGateModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto animate-in fade-in duration-300">
      <div className="bg-white dark:bg-[#161817] rounded-3xl max-w-xl w-full shadow-2xl border border-[#E5E7EB] dark:border-[#242826] overflow-hidden text-left my-6 transition-colors relative flex flex-col max-h-[92vh]">
        {/* Top Header Banner */}
