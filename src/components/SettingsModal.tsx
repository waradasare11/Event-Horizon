        ...
        <div className="p-5 sm:p-6 space-y-6 overflow-y-auto">
          ...
          <div className="p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-800 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-indigo-600 text-white font-bold text-sm flex items-center justify-center">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl text-xs font-bold bg-teal-500/10 text-teal-700 dark:text-teal-300 border border-teal-500/20 hover:bg-teal-500/20 transition-all flex items-center gap-1.5"
              >
          ...
          <div className="p-4 rounded-2xl bg-teal-500/5 dark:bg-teal-500/10 border border-teal-500/20 space-y-2">
            <div className="flex items-center justify-between">
            ...
            <div className="pt-1">
              <button
                ...
                className="px-3.5 py-2 rounded-xl text-xs font-bold bg-[#0F6E5F] text-white hover:bg-[#0c594c] transition-all flex items-center gap-1.5"
              >
          ...
          <div className="pt-2 border-t border-gray-100 dark:border-gray-800 flex flex-wrap items-center justify-between gap-2 text-xs text-gray-500">
            <div className="flex items-center gap-2">
              <a href="/privacy" className="hover:text-teal-600 underline">Privacy Policy</a>
              <span>•</span>
              <a href="/terms" className="hover:text-teal-600 underline">Terms</a>
              <span>•</span>
              <a href="/disclaimer" className="hover:text-amber-600 underline">Disclaimer</a>
              <span>•</span>
              <a href="/refund" className="hover:text-teal-600 underline">Refund Policy</a>
            </div>
        ...
        <div className="p-4 bg-gray-50 dark:bg-[#111312] border-t border-gray-100 dark:border-gray-800 flex items-center justify-between shrink-0">
          ...
          {currentUser ? (
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl text-xs font-bold bg-teal-600 text-white hover:bg-teal-700 transition-all flex items-center gap-1.5"
            >
